...
def region_of_intrest(img,vertices): # function for creating some triangle on picture
...
def line(image):
    ...
    cropped_image1 = region_of_intrest(edges,
                                      np.array([region_of_intrest_vertices1], np.int32)) #triangle1
    
    cropped_image2 = region_of_intrest(edges,
